...
export default function CompanyPage() {
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-sm">
      <h1 className="text-2xl font-bold text-white mb-6">Company Information</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <label htmlFor="yearsExperience" className="block text-sm font-medium text-gray-300 mb-1">
              Years of Experience
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="projectsCompleted" className="block text-sm font-medium text-gray-300 mb-1">
              Projects Completed
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="clientSatisfaction" className="block text-sm font-medium text-gray-300 mb-1">
              Client Satisfaction (%)
            </label>
            <input
              type="number"
        ...
        <div>
          <label htmlFor="aboutUs" className="block text-sm font-medium text-gray-300 mb-1">
            About Us
          </label>
          <textarea
            id="aboutUs"
