...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  const [isInWishlist, setIsInWishlist] = useState(wishlistItems.some(wishlistItem => wishlistItem.id === item.id));
  ...
  return (
    <div className="group">
      ...
      >
        <Link href="/templates/ecommerce/shop-details"> {item.title} </Link>
      </h3>
